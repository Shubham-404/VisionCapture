...
video_path = './videos/video1.mp4'  # Change this to your video file path
...
process_count = 0
attendance_record = {}  # Track when attendance was last marked for each person
skip_frames = 1  # Process every nth frame for better performance
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        if len(face_distances) > 0:
            ...
            if matches[best_match_index] and confidence > 0.4:  # Confidence threshold
                ...
                # Mark attendance with cooldown per person (30 seconds)
        ...
        # Draw face rectangle - color based on identification status
